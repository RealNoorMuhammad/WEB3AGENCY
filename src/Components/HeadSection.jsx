            ...
            <Zoom top>
              <div className="text-center  pt-5" style={{ marginTop: "10%" }}>
                ...
                <h3>
                  <em>
                    <span className="other_text">
                      We leverage the skills, knowledge, and passion of our team
                      of web3 experts to positively impact the space and assist
                      those looking to contribute to web3 meaningfully.
                    </span>
                  </em>
                </h3>
                <br />
                ...
                <h3>
                  <em>
                    <span className="other_text">
                      ...
                      concepts while collaborating and networking with industry
                      experts who utilize the web3 technology stack to deliver
                ...
                <h3>
                  <em>
                    <span className="other_text">
                      Put simply, SNDC8 strives to contribute to the innovation,
                      enhancement, and refinement of web3, as we believe web3
                      technology will benefit billions of people around the
                      globe.
                    </span>
                  </em>
                </h3>
